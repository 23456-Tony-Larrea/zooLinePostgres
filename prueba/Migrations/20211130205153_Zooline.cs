...
{
    public partial class Zooline : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ContinenteClima",
                columns: table => new
                {
                    ContinenteClimaId = table.Column<int>(nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ContinenteId = table.Column<int>(nullable: false),
                    ClimaId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContinenteClima", x => x.ContinenteClimaId);
                    table.ForeignKey(
                        name: "FK_ContinenteClima_Clima_ClimaId",
                        column: x => x.ClimaId,
                        principalTable: "Clima",
                        principalColumn: "ClimaId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContinenteClima_Continente_ContinenteId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Especie_Habitat_HabitatId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContinenteClima_ClimaId",
                table: "ContinenteClima",
                column: "ClimaId");

            migrationBuilder.CreateIndex(
                name: "IX_ContinenteClima_ContinenteId",
                table: "ContinenteClima",
                column: "ContinenteId");

            migrationBuilder.CreateIndex(
                name: "IX_Especie_HabitatId",
                table: "Especie",
                column: "HabitatId");
