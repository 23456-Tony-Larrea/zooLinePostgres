...
namespace ZooLine.Views.ClimaTempladoOriente
{
    public class ClimaTempladoOrienteController : Controller
    {
        private readonly ApplicationDbContext _dbAplicacion;
        public ClimaTempladoOrienteController(ApplicationDbContext context)
        {
