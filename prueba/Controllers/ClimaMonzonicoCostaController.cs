...
namespace ZooLine.Views.ClimaMonzonicoCosta
{
    public class ClimaMonzonicoCostaController : Controller
    {
        ...
        public ClimaMonzonicoCostaController(ApplicationDbContext context)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var animales = await _dbAplicacion.Animales.Where(x => x.EspecieId <= 41 && x.EspecieId > 35).OrderByDescending(x => x.AnimalId).Select(x => new CardModel
            {
