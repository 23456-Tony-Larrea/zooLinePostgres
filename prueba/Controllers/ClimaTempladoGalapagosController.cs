...
namespace ZooLine.Views.ClimaTempladoGalapagos
{
    public class ClimaTempladoGalapagosController : Controller
    {
        private readonly ApplicationDbContext _dbAplicacion;
        public ClimaTempladoGalapagosController(ApplicationDbContext context)
        {
